    ...
    <v-row no-gutters>
      <v-col cols="12">
        ...
        <v-row no-gutters class="flex-row-reverse">
          ...
          <v-col cols="12" md="6" align-self="center">
            <div class="px-8 py-2">
              <h2 class="text-h3 text-center font-weight-black">Zakir Hussain Rose Garden</h2>
              <h3
                class="text-h5 text-uppercase font-weight-thin text-center my-8"
              >
              ...
              <p>
                Spread across an area of more than 30 acres of land, Zakir Hussain Rose Garden in Chandigarh holds some of the most elegant and fascinating collections of roses from India and the world. The garden is named and formed in the memory of India's former president, Zakir Hussain. Migrating from various parts of the country, a collection of more than 16,00 species of 50,00 rose plantations can be found here.
        ...
        <v-row no-gutters>
          ...
          <v-col cols="12" md="6" align-self="center">
            <div class="px-8 py-2">
              <h2 class="text-h3 text-center font-weight-black">Government Museum & Art Gallery</h2>
              <h3
                class="text-h5 text-uppercase font-weight-thin text-center my-8"
              >
              Location: Government Museum & Art Gallery, 502 sector, 10C, Chandigarh, 160011
              </h3>
              <p>
        ...
        <v-row no-gutters class="flex-row-reverse">
          ...
          <v-col cols="12" md="6" align-self="center">
            <div class="px-8 py-2">
              ...
              <p>
                The gorgeous Sukhna Lake, found in Chandigarh, was brought into existence by damming the Sukhna Chole in 1958. Strearched in 3 km, the lake is encompassed with sparkling water, boats and serves as home for a number of birds including the Siberian duck and the crane.
